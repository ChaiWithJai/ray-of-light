...
const l1 = d({
	...
	lines: [
		...
		{ target: 'எனக்கு ஒரு காபி வேணும்.', translit: 'enakku oru kāpi vēṇum.', literal: 'To-me one coffee is-wanted.', english: "I'd like a coffee.", speaker: 'வாடிக்கையாளர்', constructions: ['enakku-venum'], chunks: ['enakku', 'oru kāpi', 'vēṇum'], notes: [{ type: 'grammar', text: 'Tamil has no verb "to want" taking a subject. The wanter goes in the dative (எனக்கு "to me") and the thing wanted is the subject. This pattern will carry you a long way.', anchor: 'எனக்கு' }, { type: 'morphology', text: 'எனக்கு = நான் (I) + dative -க்கு.', anchor: 'எனக்கு' }, { type: 'culture', text: 'அண்ணா "elder brother" (or அக்கா "elder sister") is the standard friendly way to address a shopkeeper or tea-shop man — polite, not familial. No word for "please" is needed; the -ங்க ending on the verb does that work.', anchor: 'காபி' }] },
		...
		{ target: 'இதோ உங்க காபி.', translit: 'idhō uṅga kāpi.', literal: 'Here your coffee.', english: 'Here is your coffee.', speaker: 'கடைக்காரர்' },
	...
	exercises: [
		...
		{ kind: 'recall', prompt: 'Say it in Tamil: "I\'d like a coffee."', canonical: 'எனக்கு ஒரு காபி வேணும்.', accepted: ['எனக்கு ஒரு காபி வேணும்.', 'enakku oru kāpi vēṇum', 'enakku oru kaapi vēṇum'], hints: ['எனக்கு…'], constructions: ['enakku-venum'] },
...
const l3 = d({
	...
	lines: [
		...
		{ target: 'ஒரு கிலோ குடுங்க.', translit: 'oru kilō kuḍuṅga.', literal: 'One kilo give-please.', english: 'Give me a kilo, please.', speaker: 'வாடிக்கையாளர்', constructions: ['oru-kilo', 'kudunga'], chunks: ['oru kilō', 'kuḍuṅga'], notes: [{ type: 'grammar', text: 'The -ங்க ending is the polite/plural imperative. Dropping it (குடு) is what you say to a child or a close friend.', anchor: 'குடுங்க' }, { type: 'grammar', text: 'The polite "don\'t" is -ாதீங்க: போடாதீங்க "please don\'t put (any more)", கவலைப்படாதீங்க "please don\'t worry". With close friends and children the short form is -ாத: கவலைப்படாத.', anchor: 'குடுங்க' }] },
	...
	exercises: [
		...
		{ kind: 'recall', prompt: 'Say it in Tamil: "Give me a kilo, please."', canonical: 'ஒரு கிலோ குடுங்க.', accepted: ['ஒரு கிலோ குடுங்க.', 'oru kilō kuḍuṅga'], hints: ['ஒரு…'], constructions: ['kudunga'] },
...
const l6 = d({
	...
	lines: [
		...
		{ target: 'பில் குடுங்க.', translit: 'bill kuḍuṅga.', literal: 'Bill give-please.', english: 'The bill, please.', speaker: 'வாடிக்கையாளர்', constructions: ['bill-kudunga', 'kudunga'], notes: [{ type: 'culture', text: 'English loans slot straight into spoken Tamil — பில், ரூம், ரெஸ்ட் — and take Tamil endings like native words, including the adverbial -ஆ: ஹெவியா "heavy(-ish)", லைட்டா "light(-ly)".', anchor: 'பில்' }] },
	...
	exercises: [
		...
		{ kind: 'recall', prompt: 'Say it in Tamil: "The bill, please."', canonical: 'பில் குடுங்க.', accepted: ['பில் குடுங்க.', 'bill kuḍuṅga'], hints: ['பில்…'], constructions: ['bill-kudunga'] },
...
const l7 = {
	...d({
		...
		lines: [
			...
			{ target: 'காபி கடை எங்க இருக்கு?', translit: 'kāpi kaḍai eṅga irukku?', literal: 'Coffee shop where it-is?', english: 'Where is the coffee shop?', speaker: 'பயணி' },
			...
			{ target: 'எனக்கு ஒரு காபி வேணும். எவ்வளவு?', translit: 'enakku oru kāpi vēṇum. evvaḷavu?', literal: 'To-me one coffee is-wanted. How-much?', english: "I'd like a coffee. How much?", speaker: 'பயணி' },
...
const l14 = {
	...d({
		...
		lines: [
			...
			{ target: 'வீட்ல காபி இருக்கா?', translit: 'vīṭla kāpi irukkā?', literal: 'House-in coffee is-there-Q?', english: 'Is there coffee at home?', speaker: 'ராஜா' },
			...
			{ target: 'சரி: காபி, அப்புறம் மியூசியம். கண்டிப்பா!', translit: 'sari: kāpi, appuṛam museum. kaṇḍippā!', literal: 'Fine: coffee, then museum. Certainly!', english: 'Right: coffee, then museum. Definitely!', speaker: 'ராஜா' }
		],
		exercises: [
