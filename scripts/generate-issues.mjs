...
domain but dated — modernise, do not present as-is.`,
	...
	{
		id: 'T-05', slug: 'tamil-morphology-native-annotation',
		title: 'Annotate Tamil morphology natively (TTB is thin on spoken forms)',
		labels: ['ticket', 'data', 'content'],
		body: `**Licence status: resolved.** This project is non-commercial, and UD_Tamil-TTB
